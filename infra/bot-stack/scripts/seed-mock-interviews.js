...
const RECORDS = [
  {
    role: "父",
    situation: "小学校受験の保護者面接（父役の想定問答練習）",
    ...
    summary:
      ...
      "・母にも同じ質問（特に教育方針まわり）に答えてもらい、夫婦で内容の食い違いがないか確認する",
  },
  {
    role: "家族",
    situation: "小学校受験の面接（塾でのコーチ付き模擬面接、本人・父・母 同席の家族面接形式）",
    schoolCharacteristics: "",
    channel: "seed",
    createdAt: "2026-08-01T00:00:00.000Z",
    summary:
      "よかった点:\n" +
      "・本人: 最初は緊張していたが、名前を聞かれたあたりから受け答えが安定してきた\n" +
      ...
      "・名前の由来を子に語りかける場面で、父ももっと踏み込んで子どもに触れる・母と一緒に子を見つめる・母の言葉に頷く等、大げさなくらいのスキンシップ・相槌を意識すると、家族としての一体感がさらに伝わる（本人は照れ屋なので特に）\n" +
      "・本人の回答は、語尾に「です」をつけるとより丁寧で完成度の高い印象になる\n" +
      "・本人が、自宅の住所・電話番号（家族の携帯番号）を答えられるようにしておく（今回は答えられなかった）\n" +
      ...
      "・本人: 自宅の住所・電話番号（家族の携帯番号）を覚える\n" +
      "・本人: 回答の語尾に「です」をつける練習をする\n\n" +
      "補足（一般的な面接評価について）:\n" +
