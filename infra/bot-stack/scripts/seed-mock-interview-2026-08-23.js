...
const RECORDS = [
  {
    ...
    summary:
      ...
      "・友達に怪我をさせた場合の対応で「まず本人を信じ、寄り添って理由を聞く」「学校の判断を尊重して対応する」と、私立受験で重視される学校中心の対応方針を明確に答えられていた\n" +
  ...
  },
  {
    ...
    summary:
      ...
      "・家庭の教育軸（「自立」「自分で考える」「自分で解決する」）と、本人の人物像（「慎重に考えてから行動」「思慮深い」「友達に優しい」「探求心・集中力」）について、父母の回答に一貫性があった\n\n" +
      "改善が必要な点:\n" +
