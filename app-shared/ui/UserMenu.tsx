...
//
// app/配下の各アプリはpreserveSymlinks:trueなVite設定（ShareButton.jsx等と同様）
// のもとapp-shared/ui/からsymlinkで共有する（examination#447）。以前は各アプリへ
// ファイルコピーで複製しておりjscpdの重複率を大きく押し上げていた
//
