...
旧: このファイルに手書きされていた記録（2026-08-01の2件）はexamination#93の
一度きりの移行スクリプト（infra/bot-stack/scripts/seed-mock-interviews.js）で
DynamoDB（examination-mock-interviews）へ投入済み。以降はLINE/音声練習の終了時に
AIが自動生成したサマリーが同テーブルへ蓄積され、React画面がそれを表示する。
過去の記録本文はgit履歴を参照。
-->
